...
{
	if (!TheTextureManager::Instance()->load("assets/PacktAssets/helicopter.png",
	...
	if (!TheTextureManager::Instance()
		->load("assets/PacktAssets/helicopter2.png", "helicopter2",
	...
	GameObject* player = new Player(new LoaderParams(100, 100, 128,
		55, "helicopter"));
	GameObject* enemy = new Enemy(new LoaderParams(400, 100, 128,
		55, "helicopter2"));
